...
export default {
  ...
  methods: {
    ...
    changeIndex: throttle(function (index) {
      ...
      //就是由于用户行为过快，导致浏览器反应不过来，如果当前回调函数中
    ...
    goSearch(event) {
      ...
      //存在的另一个问题：即使你能确认点击的是a标签，如何区分是一级、二级、三级分类的标签

      //第一个问题：吧子节点当中a标签，加上自定义属性data-categoryName,其余子节点是没有的
